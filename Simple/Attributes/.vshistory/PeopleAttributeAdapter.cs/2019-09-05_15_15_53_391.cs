...
namespace Simple.Attributes
{
    ...
    public class PeopleAttributeAdapter : AttributeAdapterBase<ClassicMovieAttribute>
    {
        private int _year;

        public PeopleAttributeAdapter(ClassicMovieAttribute attribute, IStringLocalizer stringLocalizer) : base(attribute, stringLocalizer)
        {
